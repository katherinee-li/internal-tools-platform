...
- **Cumulative ≈ 3h05m** (~2,400 LOC of TypeScript, the large majority generated by Devin), within the exercise's 3–4h total guideline.
- **The headline:** the *working software* — platform, all workflows, the connector seam, the live-data tool, the container, and CI — was built in a small fraction of that; the rest is review, testing, recording, and docs. Evidence: this repo + engineering journal + the passing CI check on the PR.
